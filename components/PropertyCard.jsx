...
const PropertyCard = ({ property }) => {
  ...
  return (
    <div className="flex flex-col rounded-lg shadow-md relative">
      <Image
      ...
      <div className="flex lg:flex-row justify-between items-center mt-auto p-4 border-t border-gray-100">
